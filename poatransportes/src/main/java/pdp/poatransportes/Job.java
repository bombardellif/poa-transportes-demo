...
public class Job {
	...
	public static void main(String[] args) throws Exception {
		...
		// Read data input (batch)
		List<Tuple5<Integer, Integer, Double, Double, Double>> input = new ArrayList<>();
		input.add(new Tuple5<Integer, Integer, Double, Double, Double>(123, 1, 0.0, 54.23, 49.87));
		input.add(new Tuple5<Integer, Integer, Double, Double, Double>(123, 1, 3.5, 55.9, 50.5));
		input.add(new Tuple5<Integer, Integer, Double, Double, Double>(123, 1, 7.5, 45.0, 40.5));
		DataSource<Tuple5<Integer, Integer, Double, Double, Double>> phoneData = env.fromCollection(input);
		
		phoneData.sortPartition(0, Order.ASCENDING) // Order by linha_id
			...
			.reduceGroup(new ReducerMatchCoordinates())
			.print();
